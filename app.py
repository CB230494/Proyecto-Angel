# =========================
# 📊 Diagrama MPGP – Exportador (rama SÍ hiper-compacta con inicio alto)
# =========================
...
st.caption("Rama SÍ puede iniciar mucho más arriba. Exporta PNG / PDF / PPTX.")
...
SAFE=16
ARROW_HEAD=18
HEAD_CLEAR=SAFE+ARROW_HEAD+6  # separación entrada/salida vs texto
...
with g1:
    # Rango ampliado para subir MUCHO la rama SÍ
...
def render_png() -> bytes:
    ...
    # ---------- Rama SÍ (inicio MUY alto posible) ----------
    rx=cx+620
    n=8
    # Coloca el primer SÍ donde pidas, pero nunca por encima de este margen superior:
    TOP_GUARD = 140   # puedes bajar a 120 si quieres aún más arriba
    ...
    # cuando falte espacio, la auto-corrección ya no empuja hacia abajo por el rombo
